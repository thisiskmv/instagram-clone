      ...
      <FormControl >
        ...
        >
          ...
          <Box padding={"0.3rem"}>
            <InputGroup size="md">
              ...
              <InputRightElement width="4.5rem">
                <Button h="1.75rem" size="sm" color="grey" colorScheme='none' variant={"ghost"} _hover={{ color: 'blue.400' }} onClick={handleClick}>
                  {show ? "Hide" : "Show"}
                </Button>
              </InputRightElement>
            </InputGroup>
          ...
          <Box>
            ...
            <Center>
              <Box p='1.5rem'>
                {error && <Text color='red' fontSize='0.9rem' fontWeight='500'>something went wrong</Text>}
              </Box>
            </Center>
          </Box>
        </Box>
